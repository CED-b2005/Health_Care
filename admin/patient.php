                            ...
                            <table width="93%" class="sub-table scrolldown"  style="border-spacing:0;">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="table-headin">Event</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
        ...
        $action=$_GET["action"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            <table cellspacing="0" cellpadding="2" width="80%";class="sub-table scrolldown add-doc-form-container">
                                <tr>
                                    <td>
                                        <p style="padding: 0;margin-top:10px;text-align: center;font-size: 25px;font-weight: bold;color:#71a3c1">View Details</p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style= "border: 1px solid #71a3c1;" class="label-td tb-td"colspan="2">
                                        P-'.$id.'
                                    </td>
                                </tr>
                                <tr>
