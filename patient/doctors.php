...
<body>
    ...
    if ($_GET) {
        ...
        if ($action == 'edit') {
            ...
            $errorlist = [
                '1' => '<label class="form-label" style="color:red;text-align:center;">Already have an account for this Email address.</label>',
                '2' => '<label class="form-label" style="color:red;text-align:center;">Password Confirmation Error! Reconfirm Password.</label>',
                '3' => '',
                '4' => '',
                '0' => '',
            ];
