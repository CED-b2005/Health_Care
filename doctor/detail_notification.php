...
<body>
    <div class="container">
        ...
        <div class="detail-item">
            ...
            <span class="value"> Response request</span>
        </div>
        <div class="detail-item">
            <span class="label">Nội dung yêu cầu của bạn:</span>
            <span class="value"><?php echo $notification['message']; ?></span>
        </div>
        <div class="detail-item">
            <span class="label">Trạng Thái Đã Đọc:</span>
            <span class="value"><?php echo $notification['is_read'] ? 'Đã Đọc' : 'Chưa đánh dấu'; ?></span>
        </div>
        <div class="detail-item">
